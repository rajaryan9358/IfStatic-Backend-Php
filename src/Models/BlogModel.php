...
final class BlogModel extends BaseModel
{
    ...
    private function toPayload(array $blog): array
    {
        return [
            ...
            'meta_schema' => $blog['metaSchema'] ?? null,
            'head_tag_manager' => $blog['headTagManager'] ?? null,
            'body_tag_manager' => $blog['bodyTagManager'] ?? null,
    ...
    private function mapRow(array $row, array $topics): array
    {
        return [
            ...
            'metaSchema' => $row['meta_schema'] ?? null,
            'headTagManager' => $row['head_tag_manager'] ?? null,
            'bodyTagManager' => $row['body_tag_manager'] ?? null,
